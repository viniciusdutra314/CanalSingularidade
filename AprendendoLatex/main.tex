...
\makeatletter
\def\boxexcounter{\thetcb@cnt@pergunta}
\makeatother

\newtcolorbox[auto counter]{pergunta}[2][]{
...
\begin{titlepage}
	\begin{center}
        ...
        \LARGE{\textbf{Prática X}}\\ %Entre aqui com o número do relatório
        \Large{Nome da prática}\\ %Entre com o título do experimento
        
        \vspace{125pt}
        
        \hfill Grupo composto por: \\% Número do seu grupo
        
        \vspace{20pt} %Substitua os nomes e matrículas fictícios pelos nomes dos participantes do grupo com os seus respectivos números de matrícula.
